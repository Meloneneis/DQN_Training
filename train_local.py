...
def main():
    """Train a Deep Q-Learning agent with specified hyperparameters"""
    ...
    exploration_final_eps = 0.03764828332400635
    exploration_fraction = 0.22087886429795167
    gamma = 0.9631823101450634
    hidden_layer_config = 'medium_2layer'
    learning_starts = 500
    lr = 0.00004029835161496903
    lr_scheduler = 'none'
    normalization = 'none'
    ...
    # Fixed parameters
    agent_name = 'local_training_warmup'
    outdir = 'local_models'
    no_display = True
    ...
    wandb_run_name = f"warmup-teacher-xlarge4layer-gelu-50seeds"
    ...
    wandb.init(
        ...
        config={
            ...
            'training_type': 'local_with_warmup',
        },
        tags=['local-training', 'teacher-warmup', 'xlarge_4layer', 'gelu', '50-validation-seeds']
    )
    ...
    print()
    print(f"🔥 WARM-UP MODE: Using teacher model for first {warmup_steps} steps")
    ...
    # Start training
    print("\nStarting training with warm-up...\n")
    deepq.learn(
        env,
        lr=lr,
        total_timesteps=total_timesteps,
